...
export class MaskAndCutProgram {
    ...
    uniform int u_blendmode;//0:normal 1:multiply
    ...
    void main()
    {
        ...
        highp float maskAlpha   = texture2D(u_maskTexture,   v_textureCoordinate).a * liquidColor.a;
        ...
        {
            newAlpha = clamp(0.0, 1.0, (maskAlpha - u_lowCut) / (u_highCut - u_lowCut)) * u_opacity;
