...
import { layerCompositeWGSL } from "../wgsl/layerComposite.wgsl";
import {
    blendStateFor,
    writeOrthoMatrix,
    writeQuadPositions,
...
export class WGPULayerCompositeProgram {
    ...
    constructor(context: WGPUContext) {
        ...
        this.module = context.createShaderModule(layerCompositeWGSL);
